...
export function getConfig(env) {
    return {
        siteName: env.SITENAME || "LMSLuos_DomainPanel",
        siteIcon: env.ICON || '/file/LMS-Logo.jpg',//https://pan.811520.xyz/icon/domain-check.png
        bgimgURL: env.BGIMG || '',//https://pan.811520.xyz/icon/bg_light.webp
        githubURL: env.GITHUB_URL || 'https://github.com/lmsluos',//https://github.com/yutian81/domain-check
        blogURL: env.BLOG_URL || 'https://blog.lmsluos.com/',
        blogName: env.BLOG_NAME || 'LMSLuos Blog',
        password: env.PASSWORD || "080606",
